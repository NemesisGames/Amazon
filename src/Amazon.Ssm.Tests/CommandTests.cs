...
namespace Amazon.Ssm.Tests
{
    public class CommandTests
    {
        ...
        public void ParseCommand()
        {
            ...
            //todo: Make Timestamp parsing not throw an InvalidCastException
            //var command = JsonObject.Parse(text).As<Command>();

            //Assert.Equal(1494825472676, new DateTimeOffset(command.RequestedDateTime.value).ToUnixTimeMilliseconds());
        }
    }
}
